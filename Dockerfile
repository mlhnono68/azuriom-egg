...
RUN apk update && \
    apk add nginx mariadb mariadb-common mariadb-client curl zip php81 php81-fpm php81-pgsql php81-mysqli php81-sqlite3 php81-bcmath php81-mbstring php81-xml php81-curl php81-zip php81-gd php81-pdo php81-tokenizer php81-fileinfo php81-xmlwriter php81-ctype php81-session php81-pdo_mysql
